/* @ts-self-types="./rust_chip8_emulator.d.ts" */
...
export class WasmEmulator {
    ...
    load_rom(rom) {
        ...
        const ret = wasm.wasmemulator_load_rom(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    rgbaLen() {
        const ret = wasm.wasmemulator_rgbaLen(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    rgbaPtr() {
        const ret = wasm.wasmemulator_rgbaPtr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    set_key(key, pressed) {
        wasm.wasmemulator_set_key(this.__wbg_ptr, key, pressed);
    }
    /**
     ...
     */
    sync_rgba() {
        const ret = wasm.wasmemulator_sync_rgba(this.__wbg_ptr);
        return ret >>> 0;
    }
    tick() {
        wasm.wasmemulator_tick(this.__wbg_ptr);
    }
    /**
     * @param {number} count
     */
    tick_many(count) {
        wasm.wasmemulator_tick_many(this.__wbg_ptr, count);
    }
    tick_timers() {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./rust_chip8_emulator_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rust_chip8_emulator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
